  ...
  const faqs = [
    {
      ...
      answer:
        "Orders are typically processed within 3-5 business days and shipped via standard shipping (5-7 business days) or expedited shipping (2-3 business days).",
    },
    {
      question: "What is your return policy?",
      answer:
        "We offer free exchanges within 30 days if the item is unworn and in original condition. Returns are also accepted within 30 days.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Currently we offer pre-designed shirts for specific majors. For custom designs or bulk orders, please contact us.",
    },
    {
      question: "What sizes are available?",
      answer:
        "We offer sizes S, M, L, XL, and XXL. Check our size guide on product pages for detailed measurements.",
    },
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="card-sticker text-center">
              ...
              <p className="text-gray-700">
                Unique, hand-drawn designs that celebrate your major with
                authentic style.
              </p>
            </div>
            <div className="card-sticker text-center">
              ...
              <p className="text-gray-700">
                Order for your study group, club, or class. Mix designs and
                sizes.
              </p>
            </div>
            <div className="card-sticker text-center">
              <div className="w-16 h-16 mx-auto mb-4 flex items-center justify-center">
                ...
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d="M5 3v4M3 5h4M5 7v4M7 5h4m4 0h4v4m-4-4v4m-4 4h4m-4-4v4m-4-4h4m-4 4v4m4-4h4m-4-4v4m-4-4h4"
                  />
                </svg>
              </div>
              <h3 className="font-bold text-xl mb-3 text-black">
              ...
              <p className="text-gray-700">
                Premium materials and printing ensure your shirt lasts through
                countless wears.
              </p>
            </div>
            <div className="card-sticker text-center">
              ...
              <p className="text-gray-700">
                Designed by students, for students. Every design celebrates your
                academic journey.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="card-sticker">
              ...
              <p className="text-gray-700 mb-4 italic">
                "Finally, a shirt that actually represents my major! The design
                is so unique and the quality is amazing."
              </p>
            ...
            <div className="card-sticker">
              ...
              <p className="text-gray-700 mb-4 italic">
                "Ordered for my study group and everyone loved them! Great way
                to show major pride."
              </p>
            ...
            <div className="card-sticker">
              ...
              <p className="text-gray-700 mb-4 italic">
                "The hand-drawn style is exactly what I was looking for. So much
                better than generic college merch!"
              </p>
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <div key={index} className="card-sticker">
                ...
                >
                  <h3 className="font-bold text-lg text-black pr-4">
                    {faq.question}
                  </h3>
                  <svg
